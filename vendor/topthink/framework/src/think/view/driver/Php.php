...
class Php implements TemplateHandlerInterface
{
    ...
    protected function getTemplateFile(string $template): string
    {
        if ('' == pathinfo($template, PATHINFO_EXTENSION)) {
            ...
            $path     = $this->config['view_path'] ?: $this->getViewPath($this->app->make('http')->getName());
    ...
    private function parseTemplate(string $template): string
    {
        ...
        } elseif ($this->app->make('http')->getName()) {
            $app = $this->app->make('http')->getName();
        ...
        if ($this->config['view_path']) {
            ...
            $path = $this->getViewPath($app ?? $this->app->make('http')->getName());
        }
